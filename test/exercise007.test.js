...
const beth = 	{
 ...
 const sam = {
     ...
     name: "Sam Jones",
     screenTime: [
                  { date: "2019-06-11", usage: { mapMyRun: 50, whatsApp: 30, facebook: 40, safari: 10} },
	...
	const justinUnder = {
     ...
     name: "Justin Under",
     screenTime: [
                  { date: "2019-06-11", usage: { mapMyRun: 0, whatsApp: 0, facebook: 0, safari: 100} },
                  { date: "2019-06-13", usage: { mapMyRun: 0, whatsApp: 0, facebook: 0, safari: 99} },
                  { date: "2019-06-14", usage: { mapMyRun: 0, whatsApp: 0, facebook: 0, safari: 101} },
                 ]
    }
  ...
  test("returns list of users with over 100 minutes of screen time a day", () => {
	 ...
	 expect(getScreentimeAlertList([beth, sam, justinUnder],"2019-06-14")).toEqual(["sam_j_1989","justin_u_1988"]);
	 expect(getScreentimeAlertList([beth, sam, justinUnder],"2019-06-13")).toEqual([]);
  });
